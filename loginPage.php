...
<html lang="en">
  ...
  <body>
              ...
              <h1 class="text-center">Login</h1>
                   <form action="" method="post" style="width: 50%;margin: 0 auto">
                           ...
                           <div class="text-center ">
                              <button type="submit" name = "btnloginPage" class=" btn btn-block mybtn btn-primary tx-tfm">Login</button>
                           </div>
                           <div class="form-group">
    ...
    <footer class="py-5 bg-dark" style="margin-top: 10%;">
      <div class="container">
        <p class="m-0 text-center text-white">Copyright &copy; Bert and Marie</p>
      </div>
      <!-- /.container -->
    </footer>
