                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><?= $_SESSION['n']; ?></li>
                        </ol>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-lg-12">
                            ...
                            <div class="card-block">
                                ...
                                <div class="table-responsive table table-hover">
                                    <?php  if ($_SESSION['position'] == "Staff") {}
                                     ...
                                     <button class="btn btn-warning"><a href="update_price.php">Update Price</a></button>
                                 <?php } ?>
                                    <table class="table">
                                        <thead>
                                            <tr>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?= $row['price']; ?></td>
                                                <td><img height="150" width="150" src="<?= 'data:image/jpeg;base64,'.base64_encode( $data ).'' ?>" alt="homepage" class="light-logo" /></td>
                                                <td><?= $row['Category']; ?></td>
                                                <td><?= $row['stock']; ?></td>
                                                <?php  if ($_SESSION['position'] == "Staff") {}
                                                         else{ ?>
                                                <td>
                                                    <form action="" method="post"><input type="hidden" name="id" value="<?= $row['id']; ?>"><button name="prod_delete" class="btn btn-danger fa fa-trash"></button><br><br>
                                                     </form></td>
                                                 <?php } ?>
                                            </tr>
                                <?php  } ?>
                     ...
                     <?php 
                                  if (isset($_POST['update_price'])) {
                                    ...
                                    $sql = mysqli_query($db, "UPDATE tbl_products SET price = '$price' WHERE id = '$idd'");    
                                    if ($sql) {
