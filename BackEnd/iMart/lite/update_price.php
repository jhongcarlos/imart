            ...
            <div class="container-fluid">
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        <h3 class="text-themecolor m-b-0 m-t-0">Update Price</h3>
                        <ol class="breadcrumb">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-block">
                                <h4 class="card-title">Specify which Product you want to update the price.</h4>
                                <div class="table-responsive table table-hover">
                                    <form accept="" method="post">
                                        <div class="form-group">
                                            ...
                                            <br><br><input type="number" name="update_price" placeholder="New Price" class="form-control" required><br><br>
                                            <button name="up_price" class="btn btn-info fa fa-plus"> Update</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
