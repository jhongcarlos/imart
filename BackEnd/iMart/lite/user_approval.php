                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <?php 
                            ...
                            if ($_SESSION['email'] == "admin") {
                                ?>
                                <li> <a class="waves-effect waves-dark" href="user_approval.php" aria-expanded="false"><i class="fa fa-thumbs-up"></i><span class="hide-menu">Registration Approval</span></a>
                        </li>
                                <?php
                            }
                         ?>
                            ...
                            <div class="card-block">
                                ...
                                <div class="table-responsive table table-hover">
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <?php 
                                                $sql = mysqli_query($db, "SELECT * FROM tbl_backend_users WHERE status = 'Pending' ORDER BY id DESC");
                                            ...
                                            <tr>
                                                ...
                                                <td><form action="" method="post">
                                                    ...
                                                    <button name="user_approve" class="btn btn-success">Approve</button>
                                                </form></td>
                                            </tr>
                                        <?php } ?>
                                        </tbody>
