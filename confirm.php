  ...
  <body>
    ...
    <div class="container" style="margin: 100px" align="center">
      <form action="" method="post" class="form-group">
        <h3>Please Verify your Email</h3><br>
        <input type="text" name="conf_num" class="form-control" placeholder="####" maxlength="4"><br>
        <button class="btn btn-primary btn-block" name="verify">Verify</button>
      </form>
    </div>
